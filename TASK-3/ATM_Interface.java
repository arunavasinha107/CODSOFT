...
public class ATM_Interface extends JFrame {
    ...
    public ATM_Interface(Bank_account account) {
        ...
        withdrawButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                String input = JOptionPane.showInputDialog(ATM_Interface.this, "Enter amount to be withdrawn:");
                try {
                    double amount = Double.parseDouble(input);
                    boolean withdrawalSuccess = userAccount.withdraw(amount);
                    if (withdrawalSuccess) {
                        updateBalanceLabel();
                        JOptionPane.showMessageDialog(ATM_Interface.this, "Withdrawal successful. Current balance: " + userAccount.getBalance());
                    } else {
                        JOptionPane.showMessageDialog(ATM_Interface.this, "Insufficient balance. Cannot withdraw.");
                    }
                } catch (NumberFormatException ex) {
                    JOptionPane.showMessageDialog(ATM_Interface.this, "Invalid amount entered.");
                }
            }
        });
        ...
        depositButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                String input = JOptionPane.showInputDialog(ATM_Interface.this, "Enter amount to be deposited:");
                try {
                    double amount = Double.parseDouble(input);
                    userAccount.deposit(amount);
                    updateBalanceLabel();
                    JOptionPane.showMessageDialog(ATM_Interface.this, "Deposit successful. Current balance: " + userAccount.getBalance());
                } catch (NumberFormatException ex) {
                    JOptionPane.showMessageDialog(ATM_Interface.this, "Invalid amount entered.");
                }
            }
        ...
        checkBalanceButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(ATM_Interface.this, "Current balance: " + userAccount.getBalance());
            }
        });
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> new ATM_Interface(userAccount).setVisible(true));
    }
}